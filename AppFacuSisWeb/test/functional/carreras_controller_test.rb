...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { duracion: @carrera.duracion, nombre: @carrera.nombre, titulo_obtenido: @carrera.titulo_obtenido }
    end
  ...
  test "should update carrera" do
    put :update, id: @carrera, carrera: { duracion: @carrera.duracion, nombre: @carrera.nombre, titulo_obtenido: @carrera.titulo_obtenido }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
