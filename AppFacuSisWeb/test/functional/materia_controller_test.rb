...
class MateriaControllerTest < ActionController::TestCase
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post :create, materium: { alias: @materium.alias, codigo: @materium.codigo, contenido: @materium.contenido, hs: @materium.hs, nombre: @materium.nombre }
    end
  ...
  test "should update materium" do
    put :update, id: @materium, materium: { alias: @materium.alias, codigo: @materium.codigo, contenido: @materium.contenido, hs: @materium.hs, nombre: @materium.nombre }
    assert_redirected_to materium_path(assigns(:materium))
  end
