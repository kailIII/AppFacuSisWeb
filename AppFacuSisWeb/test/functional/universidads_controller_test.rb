...
class UniversidadsControllerTest < ActionController::TestCase
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post :create, universidad: { direccion: @universidad.direccion, nombre: @universidad.nombre, telefono: @universidad.telefono, web: @universidad.web }
    end
  ...
  test "should update universidad" do
    put :update, id: @universidad, universidad: { direccion: @universidad.direccion, nombre: @universidad.nombre, telefono: @universidad.telefono, web: @universidad.web }
    assert_redirected_to universidad_path(assigns(:universidad))
  end
